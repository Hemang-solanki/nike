...
export const Footer = () => {
    ...
    return (
        <Box h={'300px'} bg={'black'} color={'white'} mt={'40px'}>
            ...
            <Center h={'80px'}>
                <Text className="typeWritertheme">Made with <Icon as={FcLike} /> by Solanki Hemang</Text>
            </Center>
            ...
            >
                ...
                >
                    <IconLink
                        icon={FaInstagram}
                        link={"https://www.instagram.com/hemang_solanki10/"}
                    />
                    <IconLink
                        icon={FaGithub}
                        link={"https://github.com/Hemang-solanki"}
                    />
                    <IconLink
                        icon={FaLinkedin}
                        link={"https://www.linkedin.com/in/hemang-solanki-71300a254/"}
                    />
                </Flex>
